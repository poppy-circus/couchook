...
var requireConfig = {
  baseUrl: __dirname, // relative to currently executed test
  paths: {
    // loading from a specific path ensures that the module is not loaded twice
    src: path.join(projectRootPath, 'src'),    
    package_path: path.join(projectRootPath)
  },
  nodeRequire: require
};
